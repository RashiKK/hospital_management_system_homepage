...
from diagnostic import views as diagnostics_views
...
urlpatterns = [
    ...
    path('emergency_services/', emergency_views.emergency_services_view, name='emergency_services'),

    # Path for the Services page now redirected to diagnostics
    path('services/', diagnostics_views.diagnostics, name='services'),
